...
def task_runner(task):
    if task == "seen_lr":
        from experts.tray_push_pick_place import run_episode
    elif task == "left_pick_place":
        from experts.legacy.left_grasp import run_episode
    elif task == "right_pick_place":
        from experts.legacy.right_grasp import run_episode
    else:
